      ...
      <section className="relative overflow-hidden bg-white pt-16 pb-20 lg:pt-24 lg:pb-28">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-cookie-100 text-cookie-800 text-xs font-bold uppercase tracking-wide mb-6">
              <span className="w-2 h-2 rounded-full bg-cookie-500"></span>
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-6 md:gap-12 text-sm text-gray-500">
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
            <div className="relative">
              ...
              {/* Replacing picsum with a div placeholder or optimized image later. Using standard placeholder for now */}
              <div className="relative rounded-2xl shadow-xl w-full h-80 md:h-96 bg-gray-200 overflow-hidden">
                <Image
                  src="https://picsum.photos/seed/cookiesfail/600/400"
                  alt="Frustrated baker looking at expenses"
                  fill
        ...
        <div className="container mx-auto px-4 max-w-5xl">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="p-8 rounded-2xl bg-white border border-gray-100 shadow-lg hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Costing & Profit</h3>
              <p className="text-gray-600 text-sm leading-relaxed">
            ...
            <div className="p-8 rounded-2xl bg-white border border-gray-100 shadow-lg hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Operations Setup</h3>
              <p className="text-gray-600 text-sm leading-relaxed">
